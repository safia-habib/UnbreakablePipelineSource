...
set _DeploySetParametersFile=%RootPath%DynatraceUnbreakablePipelineFunction.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%DynatraceUnbreakablePipelineFunction.zip" (
echo "%RootPath%DynatraceUnbreakablePipelineFunction.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%DynatraceUnbreakablePipelineFunction.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%DynatraceUnbreakablePipelineFunction.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%DynatraceUnbreakablePipelineFunction.deploy-readme.txt" (
...
start notepad "%RootPath%DynatraceUnbreakablePipelineFunction.deploy-readme.txt"
)
echo =========================================================
goto :eof
